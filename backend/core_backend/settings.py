...
SECRET_KEY = 'django-insecure-t9kf-v@f1fiuq7)gxh^52scjfctnhf5a#v66x*xjvda&1-=1*m'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'rag_chat_db'),
...
# ==========================================
# Tăng giới hạn upload file lên 500MB (cho phép xử lý file lớn)
